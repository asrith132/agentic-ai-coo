...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    shortName: 'MTG',
    status: 'done',
    outputs: ['3 meetings scheduled this week', 'Agenda templates created'],
    tasks: ['Schedule standups', 'Prepare meeting agendas', 'Track action items'],
    risks: ['Meeting overload', 'Timezone coordination'],
    dependencies: ['Team availability'],
    recommendations: ['Limit meetings to 3/week', 'Use async updates when possible'],
    summary: 'Meeting cadence established. Weekly sync scheduled for Mondays, ad-hoc meetings for urgent items.',
  },
];
